...
const toVehicleTypeUrl = '/enterbj/platform/enterbj/toVehicleType';
...
const toVehicleType = {
  url: domin + toVehicleTypeUrl,
  method: 'POST',
  gzip: true,
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded',
    'Origin': 'https://enterbj.zhongchebaolian.com',
    'Cookie': 'JSESSIONID=C8D6D1190AA195783334A22513CC1626; UM_distinctid=160414f70260-03d489db4c86e1-4b065c28-49a10-160414f702955; CNZZDATA1260761932=296000769-1512920721-%7C1512974179',
    'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8',
    'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_2 like Mac OS X) AppleWebKit/603.2.4 (KHTML, like Gecko) Mobile/14F89',
    'Referer': 'https://enterbj.zhongchebaolian.com/enterbj/jsp/enterbj/index.html',
    'Accept-Language': 'zh-cn',
